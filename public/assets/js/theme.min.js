function init() {
    ...
    Array.from(document.querySelectorAll("#mobileMenu .navbar-nav a")).forEach(
      (t) => {
        ...
        t.href === n &&
          ...
          ((e = e.querySelector('[data-fc-type="collapse"]')).classList.add(
            "active"
          ),
          e) &&
          (frost.Collapse.getInstanceOrCreate(e).show(), t) &&
          (t.style.height = null);
      }
    );
  }
  {
    ...
    Array.from(document.querySelectorAll("#navbar .navbar-nav a")).forEach(
      (t) => {
        ...
        t.href === i &&
          (t.classList.add("active"),
          (e = t.parentElement.parentElement.parentElement)?.classList.contains(
            "nav-item"
          ) &&
            e
          ...
          (e =
            t.parentElement.parentElement.parentElement.parentElement
              .parentElement)?.classList.contains("nav-item")) &&
          e.querySelector('[data-fc-type="dropdown"]')?.classList.add("active");
      }
    );
  }
  ...
  {
    const t = document.querySelector('[data-toggle="back-to-top"]');
    window.addEventListener("scroll", function () {
      72 < window.pageYOffset
        ? (t.classList.add("flex"), t.classList.remove("hidden"))
