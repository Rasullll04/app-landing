export default [
  {
    ...
    title: "First feature",
    text: "We use a customized application tobe specifically designed a testing gnose to keep away for people.",
  },
  {
    icon: (
      <svg
    ...
    text: "In order to design a mobile app that is going to be module downloaded and accessed frequently by users.",
  },
  {
    icon: (
      <svg
    ...
    title: "Third feature",
    text: " A Private Limited is the most popular type of partnership Malta. The limited liabilityis",
  },
  {
    icon: (
      <svg
    ...
    text: " Few derived into talking being in merit long you'd his the of to had the to duties, it them one...",
  },
];